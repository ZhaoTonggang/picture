var seting = {
    apiUrl: "https://cartoon.heheda.top/picture-api.php",    // api地址
    ratio: 0.618,        // 图片宽高比
        ...
        success: function (jsonData) {
            ...
            for (var i = 0; i < jsonData.images.length; i++) {
                ...
                if (isPC()) {
                    ...
                    newHtml += `<div class="xben-by-img"><img data-realurl="https://cn.bing.com${jsonData.images[i].url}" src="https://cn.bing.com${jsonData.images[i].url}" /> <p class="title">${title}<a href="${downUrl}" class="xben-bing-download">&nbsp|&nbsp立即下载</a></p><p class="copyright">${copyright}</p></div>`;
